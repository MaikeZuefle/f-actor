...
# directories
MODEL_DIR=MODEL_DIR_NEEDS_TO_BE_DEFINED/f-actor-nanocodec-system-loss-only
...
TALK_TO_ITSELF=true # to generate dialogues where two model instances talk to each other
